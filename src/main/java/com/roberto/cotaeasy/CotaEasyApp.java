...
public class CotaEasyApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.roberto.controle.CotaEasyApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(com.roberto.controle.CotaEasyApp.class);
