...
import com.roberto.cotaeasy.repository.LogEmailRepository;
    ...
    public void enviarEmail() throws Exception {
        try {
            ...
            new javax.mail.Authenticator() {
                ...
                {
                    return new PasswordAuthentication("cotaeasy@gmail.com", "cotaeasy123456789");
                }
            });
            Message email = new MimeMessage(session);
            email.setFrom(new InternetAddress("cotaeasy@gmail.com"));
