...
public class AjustarTemperaturaService {
    ...
    public void notificarUsuario(Integer temperatura) throws Exception {
        ...
        if (deveEnviarNotificacao) {
            new EmailService("Anomalia na temperatura", "Existe uma anomalia na temperatura do aviário, temperatura atual se encontra em: "+ temperatura.toString() +"", ETipoEmail.ANOMALIA).enviarEmail();
        }
    }
